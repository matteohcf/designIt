...
--
-- Host: localhost:3306
-- Creato il: Apr 11, 2024 alle 14:32
...
(62, '#ffab01', '#f5ec00', '#fefb41', '#fff994', 6, 35),
(65, '#5bbcff', '#fffab7', '#ffd1e3', '#7ea1ff', 24, 11),
(66, '#1c1678', '#8576ff', '#7bc9ff', '#a3ffd6', 13, 11),
(67, '#fa7070', '#fefded', '#c6ebc5', '#a1c398', 21, 10),
(68, '#401f71', '#824d74', '#be7b72', '#fdaf7b', 15, 10),
(69, '#7e62a7', '#d651b3', '#ce9992', '#efc8af', 7, 10),
(71, '#86469c', '#bc7fdc', '#fb9ad1', '#ffcdea', 11, 10),
...
(90, '#c5ee91', '#ecbe79', '#59b19b', '#b4e59a', 1, 10),
(91, '#c5ee91', '#93e1aa', '#59b19b', '#718e81', 1, 10),
(92, '#52d6fc', '#93e3fd', '#cbf0ff', '#f9fdff', 1, 10),
(93, '#1f2544', '#474f7a', '#81689d', '#ffd0ec', 13, 10),
...
(98, '#008DDA', '#41C9E2', '#ACE2E1', '#F7EEDD', 0, 42);
...
--
ALTER TABLE `likes`
  MODIFY `id_like` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=341;

--
-- AUTO_INCREMENT per la tabella `palettes`
--
ALTER TABLE `palettes`
  MODIFY `id_palette` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;

--
-- AUTO_INCREMENT per la tabella `save_palettes`
--
ALTER TABLE `save_palettes`
  MODIFY `id_save` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;

--
-- AUTO_INCREMENT per la tabella `utenti`
--
ALTER TABLE `utenti`
  MODIFY `id_utente` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
COMMIT;
